...
# 
    ...
    parser.add_argument('--dataset', type=str, default='stackoverflow', help='Dataset')
    ...
    if args.dataset == 'Flights':
        node_feature = torch.random(n_node,128)
    else:
    ...
    for rep in range(args.repeat):
        ...
        if args.fusion == 'v2t':
            ...
            from scalable_tgn_affine_time_test import train_scalable_tgn,Predict_layer,Encoder
